...
download_executable "https://github.com/jjziets/gddr6_temps/releases/download/v5.0-pre/nvml_direct_access"
download_executable "https://github.com/jjziets/gddr6_temps/releases/download/v5.0-pre/metrics_exporter"
